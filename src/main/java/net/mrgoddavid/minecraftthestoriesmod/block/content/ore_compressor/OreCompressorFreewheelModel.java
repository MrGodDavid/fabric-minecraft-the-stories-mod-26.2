...
public class OreCompressorFreewheelModel extends Model<OreCompressorBlockRenderState> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        wheel.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(54, 75).addBox(-0.5F, -6.5F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        wheel.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(16, 74).addBox(-0.5F, -6.5F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        wheel.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(12, 74).addBox(-0.5F, -6.5F, -0.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
        ...
        wheel.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(22, 70).addBox(-1.0F, -7.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
        ...
        wheel.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(66, 65).addBox(-1.0F, -7.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
        ...
        wheel.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(66, 58).addBox(-1.0F, -7.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
        ...
        wheel.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(38, 63).addBox(-1.0F, -7.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
        wheel.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(4, 74).addBox(-0.5F, -6.5F, -0.5F, 1.0F, 5.5F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, 0.0F, 0.7854F, 0.0F, 0.0F));
