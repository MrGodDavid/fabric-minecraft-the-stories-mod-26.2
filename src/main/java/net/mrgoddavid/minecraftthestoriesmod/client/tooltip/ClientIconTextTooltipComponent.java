...
public class ClientIconTextTooltipComponent implements ClientTooltipComponent {
    ...
    public ClientIconTextTooltipComponent(@Nullable ItemStack item, @Nullable Identifier icon, @Nullable FormattedCharSequence text) {
        this(item, icon, text, 16, 4, 0);
    }

    public ClientIconTextTooltipComponent(@Nullable ItemStack item, @Nullable Identifier icon, @Nullable FormattedCharSequence text, int iconSize, int iconTextGap , int verticalGap) {
        this.item = item;
        this.icon = icon;
        this.text = text;
    ...
    public int getHeight(Font font) {
        return (item != null || icon != null) ? iconSize : font.lineHeight + verticalGap;
    }
    ...
    public static ClientIconTextTooltipComponent text(FormattedCharSequence text, int verticalGap) {
        return new ClientIconTextTooltipComponent(null, null, text, 0, 4,  verticalGap);
    }
}
